...
/*   Updated: 2025/02/05 00:14:18 by maamine          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		float *data, char *text)
{
	...
	button_set(&(mlx->ui.interface_buttons[mlx->ui.btn_count]), "+", data, (t_button_f)float_inc);
	...
	button_set(&(mlx->ui.interface_buttons[mlx->ui.btn_count + 2]), "-", data, (t_button_f)ufloat_dec_01);
		...
		float *data, char *text)
{
	...
	mlx->ui.interface_buttons[mlx->ui.btn_count + 2]
		= button_new(pos.x + 100, pos.y, 20, 20);
	button_set(&(mlx->ui.interface_buttons[mlx->ui.btn_count + 2]), "-", data, (t_button_f)ufloat_dec);
	mlx->ui.interface_numpad[mlx->ui.pad_count]
		= numpad_new(data, false, pos.x + 30, pos.y + 40);
	mlx->ui.btn_count += 3;
	mlx->ui.pad_count += 1;
