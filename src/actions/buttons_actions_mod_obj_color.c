...
/*   Updated: 2025/02/05 00:13:43 by maamine          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		unsigned char *data, char *text)
{
	...
	button_set(&(mlx->ui.interface_buttons[mlx->ui.btn_count]), "+", data, (t_button_f)char_inc);
	...
	button_set(&(mlx->ui.interface_buttons[mlx->ui.btn_count + 2]), "-", data, (t_button_f)char_dec);
