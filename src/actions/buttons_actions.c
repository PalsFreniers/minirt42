...
void	button_add_scene(struct s_mlx *mlx)
{
	...
	mlx->ui.interface_buttons[0] = button_new(100, BASE_LINE_Y, 100, 60);
	button_set(&(mlx->ui.interface_buttons[0]), "sphere", mlx,		(t_button_f)button_add_sphere);
	mlx->ui.interface_buttons[1] = button_new(250, BASE_LINE_Y, 100, 60);
	button_set(&(mlx->ui.interface_buttons[1]), "light", mlx,		(t_button_f)button_add_light);
	mlx->ui.interface_buttons[2] = button_new(400, BASE_LINE_Y, 100, 60);
	button_set(&(mlx->ui.interface_buttons[2]), "plane", mlx,		(t_button_f)button_add_plane);
	mlx->ui.interface_buttons[3] = button_new(250, BASE_LINE_Y + 110, 100, 60);
	button_set(&(mlx->ui.interface_buttons[3]), "cylinder", mlx,	(t_button_f)button_add_cylinder);
	mlx->ui.btn_count = 4;
}
